...
export const CameraIcon: React.FC<{className?: string}> = ({className = "h-12 w-12 text-gray-500"}) => (
...
export const TranslateIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m4.25 16l-4.25-4.25M9 16.75V19.5M15.75 21L12 16.75M18 10a5 5 0 00-5-5M13 5V3M18 10h3M18 10a5 5 0 01-5 5m-2.25-9.25L10 3m-2.25 2.25L5.5 3M3 10h3" />
    </svg>
);
